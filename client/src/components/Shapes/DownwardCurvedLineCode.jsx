...
/**
 * This component is used to render a downward curved line with a black stroke.
 * The curve is created by using a quadratic bezier curve. The control point is
 ...
 * @param {object} props
 * 
 * @returns {JSX.Element} DownwardCurvedLineCode
 */
